...
def test_objs_typicality_avg_1(similarity_function):
...
def test_objs_typicality_avg_2(similarity_function):
...
@ pytest.mark.parametrize("similarity_function", [jaccard, smc, rosch])
def test_objs_typicality_avg_3(similarity_function):
...
def test_objs_typicality_avg_4(similarity_function):
